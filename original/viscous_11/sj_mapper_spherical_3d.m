function [gbfs1,gbfs2,iZeros,iOnes,surface_derivatives]=sj_mapper_spherical_3d(nx,ny,nz,X,Y,Z)
...
iZeros=zeros(1,1001*n_edge_deg_1+665*n_edge_deg_2+441*n_edge_deg_3);
iOnes=zeros(1,7*(n_edge_deg_1+n_edge_deg_2+n_edge_deg_3));
surface_derivatives=iOnes;

iZero=0;
iOne=0;
isurface_derivatives=0;

1001*n_edge_deg_1+665*n_edge_deg_2+441*n_edge_deg_3
7*(n_edge_deg_1+n_edge_deg_2+n_edge_deg_3)
...
%             %===============================
            ...
            if isEdge_3d(xth,yth,zth,nx,ny,nz)==0
                    ...
                    for iAdjacency=2:1:27
                        if node_adjacent(iAdjacency)~=0
                            ...
                            for type2th=1:1:8
                                ...
                                %------------------
                                isurface_derivatives=isurface_derivatives+1;
                                surface_derivatives(isurface_derivatives)=X(node1);
                                isurface_derivatives=isurface_derivatives+1;
                                surface_derivatives(isurface_derivatives)=Y(node1);
                                isurface_derivatives=isurface_derivatives+1;
                                surface_derivatives(isurface_derivatives)=Z(node1);
                                
                                isurface_derivatives=isurface_derivatives+1;
                                surface_derivatives(isurface_derivatives)=0;
                                isurface_derivatives=isurface_derivatives+1;
                                surface_derivatives(isurface_derivatives)=0;
                                isurface_derivatives=isurface_derivatives+1;
                                surface_derivatives(isurface_derivatives)=0;
