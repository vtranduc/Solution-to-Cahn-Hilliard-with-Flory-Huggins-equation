function [elements,lbfs1,lbfs2]=...
    analyze_interaction_serendipity(gbf1,gbf2,nex,ney,nx,ny,nz)

[node1,type1]=analyze_gbs_serendipity(gbf1);
[node2,type2]=analyze_gbs_serendipity(gbf2);
...
for iPositional_element=1:1:8
    if gbf2_position(iPositional_element)~=0
        ...
        lbfs1(iPositional_element)=(8-iPositional_element)*4+type1;
