...
elseif grad_T==2
    ...
    if nworkers>1
        if communication_reliever==1
            sol_array=zeros(nworkers,nCoreTasks);
%             warning('make it parfor')
            parfor core=1:1:nworkers
                sol_array(core,:)=task_splitter_Lee(...
                    index_array(core,:),...
                    nCoreTasks,irow,icol,ny,n,weights,...
                    dt,dxdy,terms,wTerms,w);
            end
        ...
        elseif communication_reliever==0
            parfor index=1:1:nnz_
                ...
                for i=1:1:4
                    ...
                    sj_val=sj_val+sj_oneElement_Lee(...
                        element,relation_mx(2,i),relation_mx(3,i),weights,...
                        dt,w,...
                        terms,wTerms);
...
%             warning('make it parfor')
            parfor core=1:1:nworkers %=================================================
                sol_array(core,:)=task_splitter_degennes(...
                    index_array(core,:),...
                    nCoreTasks,irow,icol,ny,n,weights,...
                    dt,dxdy,terms,wTerms,w);
            end
        ...
        elseif communication_reliever==0
            parfor index=1:1:nnz_
                ...
                for i=1:1:4
                    ...
                    sj_val=sj_val+sj_oneElement_degennes(...
                        element,relation_mx(2,i),relation_mx(3,i),weights,...
                        dt,w,...
                        terms,wTerms);
...
function sol=task_splitter_degennes(index_ends,nCoreTasks,irow,icol,ny,n,weights,...
    dt,dxdy,terms,wTerms,w)
col_index=0;
...
for index=index_ends(1):1:index_ends(2)
    ...
    for i=1:1:4
        ...
        sj_val=sj_val+sj_oneElement_degennes(element,relation_mx(2,i),relation_mx(3,i),weights,...
            dt,w,...
            terms,wTerms);
    end
    col_index=col_index+1;
...
function solution=sj_oneElement_degennes(e,ilocal,jlocal,weights,...
    dt,w,...
    terms,wTerms)
...
for ix=1:1:3
    for iy=1:1:3
        ...
        solution=solution+w(ix)*w(iy)*(...
            ...
            ...
            ...
            +weights(ix,iy,ilocal,2)*weights(ix,iy,jlocal,1)*(terms(e,ix,iy,1)+terms(e,ix,iy,4))...
            +weights(ix,iy,ilocal,3)*weights(ix,iy,jlocal,1)*(terms(e,ix,iy,2)+terms(e,ix,iy,5))...
            ...
            ...
            +(weights(ix,iy,ilocal,2)*weights(ix,iy,jlocal,2)+weights(ix,iy,ilocal,3)*weights(ix,iy,jlocal,3))...
            *terms(e,ix,iy,3)...
            ...
            ...
            +weights(ix,iy,ilocal,2)*wTerms(ix,iy,jlocal)*terms(e,ix,iy,8)...
            +weights(ix,iy,ilocal,3)*wTerms(ix,iy,jlocal)*terms(e,ix,iy,9)...
            ...
            ...
            +(weights(ix,iy,jlocal,2)*terms(e,ix,iy,6)...
            +weights(ix,iy,jlocal,3)*terms(e,ix,iy,7))...
            *(weights(ix,iy,ilocal,2)*terms(e,ix,iy,10)...
            +weights(ix,iy,ilocal,3)*terms(e,ix,iy,11))...
            ...
            ...
            +wTerms(ix,iy,ilocal)*wTerms(ix,iy,jlocal)*terms(e,ix,iy,12)...
            ...
            ...
            +wTerms(ix,iy,ilocal)*weights(ix,iy,jlocal,1)*terms(e,ix,iy,13)...
            ...
            ...
            );
...
function sol=task_splitter_Lee(index_ends,nCoreTasks,irow,icol,ny,n,weights,...
    dt,dxdy,terms,wTerms,w)
col_index=0;
sol=zeros(1,nCoreTasks);
for index=index_ends(1):1:index_ends(2)
    ...
    for i=1:1:4
        ...
        sj_val=sj_val+sj_oneElement_Lee(element,relation_mx(2,i),relation_mx(3,i),weights,...
            dt,w,...
            terms,wTerms);
    end
    col_index=col_index+1;
...
function solution=sj_oneElement_Lee(e,ilocal,jlocal,weights,...
    dt,w,...
    terms,wTerms)
...
%         error('satoshi')
        ...
        solution=solution+w(ix)*w(iy)*(...
            ...
            *terms(e,ix,iy,3)...
            ...
            ...
            +weights(ix,iy,ilocal,2)*wTerms(ix,iy,jlocal)*terms(e,ix,iy,6)...
            +weights(ix,iy,ilocal,3)*wTerms(ix,iy,jlocal)*terms(e,ix,iy,7)...
            ...
            ...
            +weights(ix,iy,jlocal,1)*wTerms(ix,iy,ilocal)*terms(e,ix,iy,8)...
            ...
            ...
            +wTerms(ix,iy,ilocal)*wTerms(ix,iy,jlocal)*terms(e,ix,iy,9)...
            ...
            ...
            );
