function solution=sj_2d(nnz_,irow,icol,ny,n,weights,...
    dt,dxdy,terms,wTerms,...
    nworkers,...
    ...
    viscosity,sfsj_assist)
...
parfor worker=1:1:nworkers
    if worker<=extra
        temp(worker,:)=sj_2d_new_assist(allocation(worker,:),...
            ...
            dt,dxdy,terms,wTerms,w,viscosity,sfsj_assist);
    elseif worker>extra
        temp(worker,:)=sj_2d_new_assist(allocation(worker,:),...
...
for ix=1:1:3
    for iy=1:1:3
        ...
        solution=solution+w(ix)*w(iy)*(...
            ...
            weights(ix,iy,jlocal,1)*sfsj_assist(e,ix,iy,ilocal,1)/dt...
            ...
            -(terms(e,ix,iy,1)* weights(ix,iy,jlocal,1)-wTerms(ix,iy,jlocal))...
